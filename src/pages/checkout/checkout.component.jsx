    ...
    <div className="checkout-page">
        <div className="checkout-header">
            <div className="header-block">
                <span className="columnName">Product</span>
            </div>
            <div className="header-block">
                <span className="columnName">Description</span>
            </div>
            <div className="header-block">
                <span className="columnName">Quantity</span>
            </div>
            <div className="header-block">
                <span className="columnName">Price</span>
            </div>
            <div className="header-block">
                <span className="columnName">Remove</span>
            </div>
        </div>
        {
